...
//                'full-bg-image',
	    ...
	    $ma_el_business_bg_image_url_src = Group_Control_Image_Size::get_attachment_image_src( $ma_el_business_bg_image['id'], $settings['thumbnail_size'], $settings );
	    $ma_el_business_bg_image_alt = Control_Media::get_image_alt( $settings['ma_el_business_bg_image'] );
                ...
                <?php if ( ($settings['ma_el_business_hours_style'] == 'content-corner-btn') || ($settings['ma_el_business_hours_style'] == 'table-reservation') ) {?>
                    <div class="row">
                        <div class="<?php echo ($settings['ma_el_business_hours_style'] == 'table-reservation')?"col-lg-8":"col-lg-6";?>">
                            <?php if($ma_el_business_bg_image_url_src){?>
                                <img src="<?php echo esc_url ($ma_el_business_bg_image_url_src); ?>" alt="<?php echo esc_attr($ma_el_business_bg_image_alt);?>">
                            <?php } ?>
                        </div>
                <?php } ?>
