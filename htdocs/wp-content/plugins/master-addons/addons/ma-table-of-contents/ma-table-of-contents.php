...
//						'#ma-el-toc-{{ID}} .ma-el-offcanvas-bar' => 'background-color: {{VALUE}};',
		...
		private function ma_el_layout_dropdown() {
            ...
            $this->add_render_attribute( 'ma_el_dropdown_business_hours', 'class', 'table-of-content-layout-dropdown');
            ...
            <div <?php echo $this->get_render_attribute_string( 'ma_el_dropdown_business_hours' ); ?>>
