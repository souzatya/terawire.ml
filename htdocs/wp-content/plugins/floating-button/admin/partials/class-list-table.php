...
class Wow_List_Table extends WP_List_Table {
	...
	public function column_title( $item ) {
		...
		$actions       = array(
			...
			'duplicate' => '<a href="' . $duplicate_url . '" style="color:green;">' . esc_attr__( 'Duplicate', $text )
			               . '</a>',
		...
		if ( $result ) {
			foreach ( $result as $key => $value ) {
				...
				$data[] = array(
					...
					'action'     => $tool_action,
					'conversion' => $conversion,
					'edit'       => '<a href="admin.php?page=' . $slug . '&tab=add-new&act=update&id='
					                . $value->id . '">edit</a>',
					'delete'     => '<a href="admin.php?page=' . $slug . '&info=delete&did=' . $value->id
					                . '" style="color:red;">delete</a>',
					'duplicate'  => '<a href="admin.php?page=' . $slug . '&tab=add-new&act=duplicate&id='
					                . $value->id . '" style="color:green;">duplicate</a>',
				);
			}
		}
